...
public class RestauranteContract {
	...
	public static final String TAB_RESTAURANTES = "RESTAURANTES";
	...
	public static final String COL_PRECIO_MIN = "PRECIO_MIN";
	public static final String COL_PRECIO_MAX = "PRECIO_MAX";
